...
/**
  ...
  */
class SparkStreamingForSearchDigestMonitorV2 {

}

object SparkStreamingForSearchDigestMonitorV2 {

  private val logger = Logger.getLogger(classOf[SparkStreamingForSearchDigestMonitorV2])
