...
/**
  ...
  */
class SparkStreamingForGsystemMonitor {

}

object SparkStreamingForGsystemMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForGsystemMonitor])
