...
/**
  ...
  */
class SparkStreamingForTagPredictEdpsMonitor {

}

object SparkStreamingForTagPredictEdpsMonitor {

  private val logger = Logger.getLogger("SparkStreamingForTagPredictEdpsMonitor")
