...
/**
  ...
  */
class SparkStreamingForJdFeatureMonitorV2 {

}

object SparkStreamingForJdFeatureMonitorV2 {

  private val logger = Logger.getLogger(classOf[SparkStreamingForJdFeatureMonitorV2])
