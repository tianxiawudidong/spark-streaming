...
/**
  ...
  */
class SparkStreamingForCvTitleMonitorV2 {

}

object SparkStreamingForCvTitleMonitorV2 {
  private val logger = Logger.getLogger(classOf[SparkStreamingForCvTitleMonitorV2])
