...
/**
  ...
  */
class SparkStreamingForUniqServerMonitor {

}

object SparkStreamingForUniqServerMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForUniqServerMonitor])
