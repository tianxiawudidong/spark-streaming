...
/**
  ...
  */
class SparkStreamingForRelationMonitorV2 {

}

object SparkStreamingForRelationMonitorV2 {
  private val logger = Logger.getLogger(classOf[SparkStreamingForRelationMonitorV2])
