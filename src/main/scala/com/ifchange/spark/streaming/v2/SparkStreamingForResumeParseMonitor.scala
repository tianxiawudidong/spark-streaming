...
/**
  ...
  */
class SparkStreamingForResumeParseMonitor {

}

object SparkStreamingForResumeParseMonitor {


  private val logger = Logger.getLogger("SparkStreamingForResumeParseMonitor")
