...
/**
  ...
  */
class SparkStreamingForCvEntityMonitorV2 {

}

object SparkStreamingForCvEntityMonitorV2 {
  private val logger = Logger.getLogger(classOf[SparkStreamingForCvEntityMonitorV2])
      ...
      rdds.foreach(f = value => {
        ...
        if (map.nonEmpty) {
          ...
          if (s.equals("0") || responseTime >= 1000) {
            ...
            hbaseClient.setTbale("cvEntity_log")
