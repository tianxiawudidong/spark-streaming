...
/**
  ...
  */
class SparkStreamingForCvWorkYearMonitor {

}

object SparkStreamingForCvWorkYearMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForCvWorkYearMonitor])
