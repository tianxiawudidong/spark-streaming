...
/**
  ...
  */
class SparkStreamingForUserActMonitor {

}

object SparkStreamingForUserActMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForUserActMonitor])
