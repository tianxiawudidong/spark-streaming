...
/**
  ...
  */
class SparkStreamingForTagPredictMonitorV2 {

}

object SparkStreamingForTagPredictMonitorV2 {
  private val logger = Logger.getLogger("SparkStreamingForTagPredictMonitorV2")
