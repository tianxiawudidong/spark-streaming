...
/**
  ...
  */
class SparkStreamingForMainPageRecMonitor {

}

object SparkStreamingForMainPageRecMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForMainPageRecMonitor])
