...
/**
  ...
  */
class SparkStreamingForPositionMonitor {

}

object SparkStreamingForPositionMonitor {

  private val logger = Logger.getLogger(classOf[SparkStreamingForPositionMonitor])
