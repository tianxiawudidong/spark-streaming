...
/**
 * spark streaming gsystem 日志处理
 * 1、流量监控   5分钟总的请求量、总的请求时间
 * 2、性能监控   5分钟 每个f、worker的平均响应时间
 * 3、稳定性监控 5分钟 f w 失败率
 * 4、报警监控   5分钟 超时50次
 */
public class SparkStreamingForGsystemBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForGsystemBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        String appName = "spark-streaming-gsystem-monitor";
        ...
        jssc.checkpoint("/basic_data/gsystem-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.mapToPair((Tuple2<String, String> s) -> {
            ...
            if (StringUtils.isNotBlank(value))
                tuple2 = new Tuple2<>("gsystem", 1);
            else
                tuple2 = new Tuple2<>("gsystem", 0);
            return tuple2;
        ...
        JavaPairDStream<String, Double> totalTime = lines.mapToPair(s -> {
            ...
            return new Tuple2<>("gsystem", responseTime);
        }).combineByKey(s -> s, (value1, value2) -> value1 + value2, (value1, value2) -> value1 + value2, partitioner, true)
