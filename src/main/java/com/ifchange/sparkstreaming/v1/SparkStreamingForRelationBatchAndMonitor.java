...
/**
 * spark streaming relation 日志处理
 * 1、统计5分钟的量 和花费的时间
 * 2、批量监控 1分钟超时3次的
 * <p>
 * update at 18/1/3
 * 计算5分钟内，服务标记、请求work、平均响应时间
 */
public class SparkStreamingForRelationBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForRelationBatchAndMonitor.class);
    ...
    static {
        ...
        try {
            receiveMails[0] = new InternetAddress("xuelin.zhou@ifchange.com", "", "UTF-8");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appName = "spark-streaming-relation-monitor";
        ...
        jssc.checkpoint("/basic_data/relation-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.mapToPair((Tuple2<String, String> s) -> {
            ...
            if (StringUtils.isNotBlank(value))
                tuple2 = new Tuple2<>("relation", 1);
            else
                tuple2 = new Tuple2<>("relation", 0);
            return tuple2;
        ...
        JavaPairDStream<String, Double> totalTimeByFAndW = lines.mapToPair(s -> {
            ...
            if (null != map && map.size() > 0) {
                ...
                String w = StringUtils.isNotBlank(map.get("worker_name")) ? map.get("worker_name") : "w";
                String key = f + "+" + w;
                String r = StringUtils.isNotBlank(map.get("r")) ? map.get("r") : "0";
