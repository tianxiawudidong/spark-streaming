...
//     收件人邮箱（替换为自己知道的有效邮箱）
//     public static final String receiveMailAccount_2 = "";
//     public static final String receiveMailAccount = "";
...
//        transport.close();
        ...
        Address[] receiveMails = new Address[1];
...
//        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "", "UTF-8"));
    ...
    * @param content  邮件内容
    */
    public static void sendEmailByIfchange(String subject, String content,Address... receiveMail) throws Exception {
        if (null == receiveMail) {
            throw new Exception("收件人为空!!!");
        }
        String myEmailAccount2 = "";
