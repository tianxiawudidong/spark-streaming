...
/**
 * spark streaming user_act 日志处理
 * 1、流量监控   5分钟 请求总量 请求总时间
 * 2、性能监控   5分钟 f w 平均响应时间
 * 3、稳定性监控 5分钟 f w失败率
 * 4、报警监控   5分钟 超时【1s】 100次
 */
public class SparkStreamingForUserActBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForUserActBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appName = "spark-streaming-user_act-monitor";
        ...
        jssc.checkpoint("/algorithm/user_act-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.filter(s -> {
            ...
            return new Tuple2<>("user_act", num);
        ...
        JavaPairDStream<String, Double> totalTime = lines.filter(s -> {
            ...
            return new Tuple2<>("user_act", responseTime);
        ...
        pair1.foreachRDD(s -> {
            ...
            if (null != data) {
                ...
                String sql = "insert into `user_act_log_batch_result`(`from_time`,`end_time`,`total_num`,`total_use_time`,`type`)" +
