...
/**
 * spark streaming es_servers 日志处理
 * 1、流量监控   5分钟 请求总量、请求总时间
 * 2、性能监控   5分钟 f w 平均响应时间
 * 3、稳定性监控 5分钟 f w 失败率
 * 3、报警监控   5分钟 超时[1s]50次
 */
public class SparkStreamingForEsServersBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForEsServersBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        String appName = "spark-streaming-es_servers-monitor";
        ...
        jssc.checkpoint("/algorithm/es_servers-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.filter(s -> {
            ...
            String value = s._2;
            if (StringUtils.isNotBlank(value))
                tuple2 = new Tuple2<>("es_servers", 1);
            else
                tuple2 = new Tuple2<>("es_servers", 0);
            return tuple2;
        ...
        JavaPairDStream<String, Double> totalTime = lines.filter(s -> {
            ...
            return new Tuple2<>("es_servers", responseTime);
        }).combineByKey(s -> s, (value1, value2) -> value1 + value2, (value1, value2) -> value1 + value2, partitioner, true)
        ...
        JavaPairDStream<String, Tuple2<Tuple2<Integer, Double>, Integer>> pair2 = totalFailCountByFAndW.join(totalTimeByFAndW, 2).join(totalNumByFAndW);
        ...
        pair1.foreachRDD(s -> {
            ...
            if (null != data) {
                ...
                String sql = "insert into `es_servers_log_batch_result`(`from_time`,`end_time`,`total_num`,`total_use_time`,`type`)" +
