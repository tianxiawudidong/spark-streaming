...
/**
 * spark streaming cv_entity 日志处理
 * 1、流量监控   5分钟 请求总量 请求总时间
 * 2、性能监控   5分钟 f w 平均响应时间
 * 3、稳定性监控 5分钟 f w 失败率
 * 4、报警监控   5分钟 超时【1s】100次
 */
public class SparkStreamingForCvEntityBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForCvEntityBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appName = "spark-streaming-cv_entity-monitor";
        ...
        jssc.checkpoint("/algorithm/cv_entity-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.filter(s -> {
            ...
            return new Tuple2<>("cv_entity", num);
        ...
        JavaPairDStream<String, Double> totalTime = lines.filter(s -> {
            ...
            return new Tuple2<>("cv_entity", responseTime);
        }).combineByKey(s -> s, (value1, value2) -> value1 + value2, (value1, value2) -> value1 + value2, partitioner, true)
        ...
        JavaPairDStream<String, Integer> pair3 = lines.filter(s -> {
            ...
            return tuple2;
                ...
                .reduceByKeyAndWindow((Function2<Integer, Integer, Integer>) (v1, v2) -> v1 + v2,
                        Durations.minutes(5), Durations.minutes(5), 3);
        ...
        pair1.foreachRDD(s -> {
            ...
            if (null != data) {
                ...
                String sql = "insert into `cv_entity_log_batch_result`(`from_time`,`end_time`,`total_num`,`total_use_time`,`type`)" +
