...
/**
 * spark streaming search_digest 日志处理
 * 1、流量监控   5分钟 请求总量 请求总时间
 * 2、性能监控   5分钟 f w 平均响应时间
 * 3、稳定性监控 5分钟 f w 失败率
 * 4、报警监控   5分钟 超时【1s】 100次
 */
public class SparkStreamingForSearchDigestBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForSearchDigestBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appName = "spark-streaming-search_digest-monitor";
        ...
        jssc.checkpoint("/algorithm/search_digest-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.filter(s -> {
            ...
            return new Tuple2<>("search_digest", num);
        ...
        JavaPairDStream<String, Double> totalTime = lines.filter(s -> {
            ...
            return new Tuple2<>("search_digest", responseTime);
        ...
        pair1.foreachRDD(s -> {
            ...
            if (null != data) {
                ...
                String sql = "insert into `search_digest_log_batch_result`(`from_time`,`end_time`,`total_num`,`total_use_time`,`type`)" +
            ...
            if (count > 0) {
                ...
                if (null != list && list.size() > 0) {
                    ...
                    for (Tuple2<String, Integer> tuple : list) {
                        ...
                        if (value >= 100) {
                            //发邮件
                            String subject = "SEARCH_DIGEST日志报警";
