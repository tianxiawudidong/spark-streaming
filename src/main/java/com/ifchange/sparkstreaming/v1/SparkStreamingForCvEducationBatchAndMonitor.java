 ...
 */
public class SparkStreamingForCvEducationBatchAndMonitor {

    private static final Logger logger = Logger.getLogger(SparkStreamingForCvEducationBatchAndMonitor.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appName = "spark-streaming-cv_education-monitor";
        ...
        jssc.checkpoint("/algorithm/cv_education-checks");
        ...
        JavaPairDStream<String, Integer> totalCount = lines.filter(s -> {
            ...
            String value = s._2();
            if (StringUtils.isNotBlank(value))
                tuple2 = new Tuple2<>("cv_education", 1);
            else
                tuple2 = new Tuple2<>("cv_education", 0);
            return tuple2;
        ...
        JavaPairDStream<String, Double> totalTime = lines.filter(s -> {
            ...
            return new Tuple2<>("cv_education", responseTime);
        }).combineByKey(s -> s, (value1, value2) -> value1 + value2, (value1, value2) -> value1 + value2, partitioner, true)
        ...
        JavaPairDStream<String, Integer> pair3 = lines.filter(s -> {
            ...
            return tuple2;
        }).combineByKey(x -> x, (x, y) -> x + y, (x, y) -> x + y, partitioner, true)
        ...
        pair1.foreachRDD(s -> {
            ...
            if (null != data) {
                ...
                String sql = "insert into `cv_education_log_batch_result`(`from_time`,`end_time`,`total_num`,`total_use_time`,`type`)" +
            ...
            if (count > 0) {
                ...
                if (null != list && list.size() > 0) {
                    ...
                    for (Tuple2<String, Integer> tuple : list) {
                        ...
                        if (value >= 50) {
                            //发邮件
                            String subject = "CV_EDUCATION日志报警";
